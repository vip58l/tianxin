...
public class DownloadActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.openurl) {
            String path = openurl.getText().toString();
            if (!path.isEmpty()) {
    ...
    private void download() {
        if (cosxmlTask == null) {
            cosxmlTask = transferManager.download(this, bucketName, download_key, downloadParentDir.toString(), "cos_download_" + filename);
            ...
            cosxmlTask.setCosXmlResultListener(new CosXmlResultListener() {
                ...
                public void onSuccess(CosXmlRequest request, CosXmlResult result) {
                    ...
                    //Api.getPresignDownloadUrl(cosXmlService, bucketName, filename);
