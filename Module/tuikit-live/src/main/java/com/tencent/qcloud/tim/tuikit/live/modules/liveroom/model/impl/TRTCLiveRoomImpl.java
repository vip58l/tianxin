...
public class TRTCLiveRoomImpl extends TRTCLiveRoom implements ITXTRTCLiveRoomDelegate, ITXRoomServiceDelegate {
    ...
    private static final class TXCallbackHolder implements TXCallback {
        private final WeakReference<TRTCLiveRoomImpl> wefImpl;
    ...
    // 房间现在的信息
    private final TRTCLiveRoomDef.TRTCLiveRoomInfo mLiveRoomInfo;
    // 是否依赖于Tuikit使用
    ...
    private final Map<String, TXCloudVideoView> mPlayViewMap;
    ...
    // 防止内存泄露
    private final TXCallbackHolder mJoinAnchorCallbackHolder;
    // 防止内存泄露
    private final TXCallbackHolder mRequestPKHolder;
