...
public class TUILiveRoomAnchorLayout extends FrameLayout {
    ...
    public void initWithRoomId(FragmentManager fragmentManager, int roomId) {
        ...
        mLiveRoomAnchorFragment.setArguments(bundle); //传递数据
        mFragmentManager = fragmentManager;
        mFragmentManager.beginTransaction().add(R.id.live_anchor_container, mLiveRoomAnchorFragment, "tuikit-live-anchor-fragment").commit();
    }
