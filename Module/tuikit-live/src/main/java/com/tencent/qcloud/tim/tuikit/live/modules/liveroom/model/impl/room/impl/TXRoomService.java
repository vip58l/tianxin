...
public class TXRoomService implements ITXRoomService {
    ...
    private final List<IMAnchorInfo> mAnchorList;
    private int mCurrentRoomStatus;        // 房间外部状态，见 TRTCLiveRoomDef
    private String mRoomId;
    private String mPKingRoomId;
    private final IMAnchorInfo mMySelfIMInfo;
    private final IMAnchorInfo mOwnerIMInfo;
    private IMAnchorInfo mPKingIMAnchorInfo;
    private TXRoomInfo mTXRoomInfo;
    private final Map<String, String> mPKUserIdMap;    // 接收方记录一个map  一个userId对应一个requestID
    private final Map<String, String> mJoinAnchorUserIdMap;    // 接收方记录一个map  一个userId对应一个requestID
    private final LiveRoomSimpleMsgListener mSimpleListener;
    private final LiveRoomGroupListener mGroupListener;
    private final LiveRoomSignalListener mSignalListener;
    ...
    private final Map<String, TXUserInfo> mAudienceInfoMap;
    ...
    public void checkFollowState(String userId, final TRTCLiveRoomCallback.RoomFollowStateCallback callback) {
        V2TIMManager.getFriendshipManager().checkFriend(Arrays.asList(userId), V2TIMFriendInfo.V2TIM_FRIEND_TYPE_SINGLE, new V2TIMValueCallback<List<V2TIMFriendCheckResult>>() {
            @Override
            public void onError(int i, String s) {
                callback.onFailed(s);
            }
