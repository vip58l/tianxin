...
public class FloatWindow implements IFloatWindowCallback {
    ...
    public void init(Context context) {
        ...
        initView();
        mIsShowing = false;
        mTRTCKaraokeRoom = TRTCVoiceRoom.sharedInstance(context);
    ...
    public void initView() {
        ...
        ImageLoader.loadImage(mContext, mImgCover, mRoomUrl, R.drawable.trtcvoiceroom_ic_cover);
    ...
    private void click(int i) {
        if (i == R.id.iv_speaker) {
            ...
            if (mEntity != null) {
                VoiceRoomAudienceActivity.enterRoom(mContext, mEntity.roomId, mEntity.userId, mEntity.audioQuality);
            }
    ...
    public void destroy() {
        ...
        if (mTRTCKaraokeRoom != null) {
            mTRTCKaraokeRoom.exitRoom(new TRTCVoiceRoomCallback.ActionCallback() {
                @Override
