package com.tencent.liteav.trtcvoiceroom.ui.gift.utils;
...
public class AnimationUtils {
     ...
     */
    public static ObjectAnimator createFadesInFromLtoR(final View target, float star, float end, int duration, TimeInterpolator interpolator) {
     ...
     * @return 向上飞 淡出
     */
    public static ObjectAnimator createFadesOutAnimator(final View target, float star, float end, int duration, int startDelay) {
