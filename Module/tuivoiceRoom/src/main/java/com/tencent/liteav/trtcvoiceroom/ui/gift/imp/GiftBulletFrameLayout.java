...
import com.tencent.liteav.trtcvoiceroom.ui.gift.utils.AnimationUtils;
...
public class GiftBulletFrameLayout extends FrameLayout implements Handler.Callback {
    ...
    private void initLayoutState() {
        ...
        ImageLoader.loadImage(mContext, mImageSendUserIcon, mGift.sendUserHeadIcon, R.drawable.trtcvoiceroom_ic_head);
        ImageLoader.loadImage(mContext, mImageGiftIcon, mGift.giftPicUrl, R.drawable.trtcvoiceroom_ic_head);
    }
