...
public class GroupMemberManagerAdapter extends BaseAdapter {
    ...
    private static final String TAG = "GroupMemberManagerAdapter";
    ...
    public View getView(final int i, View view, final ViewGroup viewGroup) {
        ...
        GroupMemberInfo info = getItem(i);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!mGroupInfo.isOwner()||info.getUserid().equals(UserInfo.getInstance().getUserId())) {
                    return;
                }
                    ...
                    public void onClick(View v) {
                        ...
                        provider.removeGroupMembers(dels, new IUIKitCallBack() {
                            ...
                            public void onError(String module, int errCode, String errMsg) {
                                switch (errCode) {
                                    case 10004:
                                        ToastUtil.toastLongMessage(TUIKit.getAppContext().getString(R.string.remove_fail_tip));
                                        break;
                                    default:
