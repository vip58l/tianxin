...
public class FaceManager {
    ...
    private static final Context context = TUIKit.getAppContext();
    private static final String[] emojiFilters = context.getResources().getStringArray(R.array.emoji_filter);
