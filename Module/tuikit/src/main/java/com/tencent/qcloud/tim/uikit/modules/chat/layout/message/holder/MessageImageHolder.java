...
public class MessageImageHolder extends MessageContentHolder {
    private static final String TAG = MessageImageHolder.class.getSimpleName();
     ...
     * @param position
     */
    private void performImage(MessageInfo msg, int position) {
     ...
     * @param position
     */
    private void performVideo(MessageInfo msg, int position) {
        contentImage.setLayoutParams(getImageParams(contentImage.getLayoutParams(), msg));
        resetParentLayout();
    ...
    private void getVideo(V2TIMVideoElem videoElem, String videoPath, MessageInfo msg, final boolean autoPlay, int position) {
    ...
    private void play(MessageInfo msg) {
        ...
        intent.setAction("videoijkplayer");
        intent.putExtra(Constants.PATHIMG, msg.getDataPath().trim());
        intent.putExtra(Constants.PATHVIDEO, msg.getDataUri().toString().trim());
