...
public class MessageLayout extends MessageLayoutUI {
    ...
    public void postSetAdapter(MessageListAdapter adapter) {
        ...
        //返回定位GPS消息
        mAdapter.setOnMessagegps(new MessageLayout.OnMessagegps() {
            @Override
            public void OnItemClickListener(String Desc, double latitude, double longitude) {
                if (onMessagegps != null) {
                    onMessagegps.OnItemClickListener(Desc, latitude, longitude);
                }
    ...
    public interface OnMessagegps {
        void OnItemClickListener(String Desc, double latitude, double longitude);
    }
}
