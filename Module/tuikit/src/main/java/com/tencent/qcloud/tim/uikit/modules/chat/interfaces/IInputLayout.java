...
public interface IInputLayout {
     ...
     * @param disable
     */
    void disableSendgift(boolean disable);

    /**
     * 音乐
     * @param disable
     */
    void  disablemusic(boolean disable);

    /**
     * 快捷消息
     * @param disable
     */
    void  disableQuickmessage(boolean disable);

    /**
     * 定位消息
     * @param disable
     */
    void  disablelocation(boolean disable);
    ...
    void addAction(int i, InputMoreActionUnit action);
