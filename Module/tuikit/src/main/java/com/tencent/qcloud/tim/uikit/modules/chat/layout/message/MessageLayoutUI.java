...
public abstract class MessageLayoutUI extends RecyclerView implements IMessageLayout {
    ...
    protected MessageLayout.OnMessagegps onMessagegps;
    ...
    @Override
    public MessageLayout.OnMessagegps getonMessagegps() {
        return mAdapter.getOnMessagegpsListener();

    }

    @Override
    public void setgetonMessagegps(MessageLayout.OnMessagegps listener) {
        this.onMessagegps = listener;
        mAdapter.setOnMessagegps(listener);
    }
