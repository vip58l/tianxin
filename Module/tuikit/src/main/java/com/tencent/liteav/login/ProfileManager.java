    ...
    public void getUserInfoByUserId(String userId, final GetUserInfoCallback callback) {
        ...
        V2TIMManager.getInstance().getUsersInfo(userIDList, new V2TIMValueCallback<List<V2TIMUserFullInfo>>() {
            ...
            public void onSuccess(List<V2TIMUserFullInfo> v2TIMUserFullInfos) {
                ...
                userModel.userSig = userFullInfo.getSelfSignature(); //获取签名

                //自定义属性
                userModel.Gender = userFullInfo.getGender();
                userModel.tRole = userFullInfo.getRole();
                userModel.Level = userFullInfo.getLevel();
                userModel.AllowType = userFullInfo.getAllowType();
