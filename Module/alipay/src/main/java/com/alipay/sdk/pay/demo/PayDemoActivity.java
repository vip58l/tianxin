...
public class PayDemoActivity extends AppCompatActivity {
     ...
     * 用于支付宝支付业务的入参 app_id。
     */
    public static final String APPID = "2021002152627446";
    /**
     * 用于支付宝账户登录授权业务的入参 pid。
     */
    public static final String PID = "2088102551352860";
    /**
     * 用于支付宝账户登录授权业务的入参 target_id。 自定义的编号
     */
    public static final String TARGET_ID = "2201";
    /**
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Log.d(TAG, "handleMessage: " + payResult);
                    } else {
